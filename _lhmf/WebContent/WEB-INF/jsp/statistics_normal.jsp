...
<t:index>
	...
	<jsp:attribute name="scripts">
		...
		function drawPageCallback(){
			if(History.enabled){
				var newState = {data: {action:'statNormal'}, title: null, url: './statNormal'};
      ...
      <div class="round-border-topright"></div>
		...
		<dl class="menu-navigazione">
		  <dt><a id="purchaseLink" href="<spring:url htmlEscape="true" value="/purchase"/>">Schede Di Acquisto</a></dt>
